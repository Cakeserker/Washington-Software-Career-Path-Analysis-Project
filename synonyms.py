it_job_synonyms = {
    ...
    'IT Support Specialist': ['it support specialist', 'technical support specialist'],
    'DevOps Engineer': ['devops engineer'],
    'Cloud Architect': ['cloud architect', 'cloud engineer', 'cloud solutions architect'],
    'Cybersecurity Analyst': ['cybersecurity analyst', 'information security analyst', 'security analyst'],
    'UI/UX Designer': ['ui/ux designer', 'user interface designer', 'user experience designer'],
    ...
    'IT Consultant': ['it consultant', 'technology consultant'],
    'Front-end Developer': ['front-end developer'],
    'Machine Learning Engineer': ['machine learning engineer', 'ml engineer'],
    'System Administrator': ['system administrator', 'sysadmin'],
    'Security Engineer': ['security engineer', 'information security engineer'],
    'Database Developer': ['database developer', 'database programmer'],
    'IT Security Specialist': ['it security specialist', 'information security specialist'],
    'Technical Writer': ['technical writer', 'documentation specialist'],
    'Data Engineer': ['data engineer', 'big data engineer'],
    'Network Security Engineer': ['network security engineer', 'security engineer'],
    'Mobile App Developer': ['mobile app developer'],
    'Network Architect': ['network architect', 'network designer'],
    'UI Developer': ['ui developer'],
    'Business Intelligence Analyst': ['business intelligence analyst', 'bi analyst'],
    'Cloud Engineer': ['cloud engineer', 'cloud specialist'],
    'Application Support Analyst': ['application support analyst', 'application support specialist'],
    'IT Trainer': ['it trainer', 'technology trainer'],
    'IT Auditor': ['it auditor', 'information technology auditor'],
    'Solution Architect': ['solution architect'],
    'Data Manager': ['data manager'],
    'IT Project Manager': ['it project manager', 'project manager'],
    'Cybersecurity Engineer': ['cybersecurity engineer', 'security engineer'],
    'Systems Engineer': ['systems engineer', 'system engineer'],
    'Network Support Engineer': ['network support engineer', 'network support specialist'],
    'E-commerce Developer': ['e-commerce developer', 'online store developer'],
    'AI Engineer': ['ai engineer', 'artificial intelligence engineer'],
    'Data Architect': ['data architect'],
    'Technical Project Manager': ['technical project manager', 'project manager'],
...
it_job_synonyms2 = {
    ...
    'Database Architect': ['database architect'],
    'Blockchain Developer': ['blockchain developer'],
    'Technical Project Manager': ['technical project manager', 'project manager', 'technical staff'],
    'Data Architect': ['data architect'],
    'AI Engineer': ['ai engineer', 'artificial intelligence engineer'],
    'E-commerce Developer': ['e-commerce developer', 'online store developer'],
    'Network Support Engineer': ['network support engineer', 'network support specialist'],
    'Systems Engineer': ['systems engineer', 'system engineer'],
    'Cybersecurity Engineer': ['cybersecurity engineer', 'security engineer'],
    'IT Project Manager': ['it project manager', 'project manager', 'it officer'],
    ...
    'Cloud Engineer': ['cloud engineer', 'cloud specialist'],
    'Business Intelligence Analyst': ['business intelligence analyst', 'bi analyst'],
    'UI Developer': ['ui developer', 'game designer'],
    'Network Architect': ['network architect', 'network designer'],
    'Mobile App Developer': ['mobile app developer'],
    'Network Security Engineer': ['network security engineer', 'security engineer'],
    'Data Engineer': ['data engineer', 'big data engineer'],
    ...
    'QA Tester': ['qa tester', 'quality assurance tester', 'software tester'],
    'Business Analyst': ['business analyst', 'business systems analyst'],
    'UI/UX Designer': ['ui/ux designer', 'user interface designer', 'user experience designer', 'ux designer', 'ui designer'],
    'Cybersecurity Analyst': ['cybersecurity analyst', 'information security analyst', 'security analyst'],
    'Cloud Architect': ['cloud architect', 'cloud engineer', 'cloud solutions architect'],
    'DevOps Engineer': ['devops engineer'],
    'IT Support Specialist': ['it support specialist', 'technical support specialist'],
    'Systems Analyst': ['systems analyst'],
    'Web Developer': ['web developer', 'web designer', 'webmaster'],
    'Database Administrator': ['database administrator', 'dba'],
    'Network Engineer': ['network engineer'],
    'Data Scientist': ['data scientist'],
    'Software Engineer Intern': ['software engineer intern', 'software intern'],
    'Senior Software Engineer': ['senior software engineer', 'sr software engineer', 'sr. software engineer', 'staff engineer', 'staff software' 'senior engineer'],
    'Software Engineer': ['software engineer', 'software developer', 'programmer', 'developer']
}
...
it_job_synonyms3 = {
    ...
    'Data Architect': ['data', 'architect'],
    'AI Engineer': ['artificial'],
    'E-commerce Developer': ['e-commerce', 'developer'],
    'Network Support Engineer': ['network', 'support'],
    ...
    'Application Support Analyst': ['application', 'analyst'],
